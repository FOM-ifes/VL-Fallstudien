...
- Warum löst die Studentisierung das Problem der Varianz-Sensitivität der HKA?
  ...
  *Antwort:* Die studentisierten Variablen haben alle eine Varianz von eins, die Kovarianzmatrix entspricht der Korrelationsmatrix.
...
cor(irll)[1:4, 1:4]
# irll
cov(irll_std)[1:4, 1:4]
cor(irll_std)[1:4, 1:4]
```
...
# Screenplot
scree(wine, factors = FALSE)

# HKA unter Nutzung der Varimax-Rotation
hka_rotiert <- principal(wine, 3, rotate = "varimax")
...
Dies stimmt mit dem Eigenwertkriterium überein.
