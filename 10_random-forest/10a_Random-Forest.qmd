...
Dem vorherigen Kapitel können wir entnehmen, wie gut das Model performt bspw. wieviel der Varianz der Zielvariable erklärt wird.
...
mse_tuned <- mean((predicted_tuned - observed)^2)
