...
Als Datengrundlage verwenden wir die Body Fat Datentabelle von Kaggle:
...
Fügen wir die neue Variable mit der Berechnung nach @brozek_densitometric_1963 in die Datentablle ein:
...
Zusätzlich werden die oben genannten Surrogatparameter berechnet.
...
=======
>>>>>>> 1d942207c80ae5129d28bebfea76829146536d5f
...
4.  Berechnen Sie nun noch das $R^2$ und interpretieren Sie es.
...
1. Erstellen Sie ein Random Forest Modell mit der Berechnung nach Brozek (`body_fat_brozek`)
