...
Wie bereits erwähnt, werden heute Surrogatparameter zur Bestimmung des Körperfettanteils genutzt, eingie kennen Sie sicherlich:
...
Einer der Surrogatparameter ist die Waist-to-Hip Ratio.
...
# 2. Überprüfen der Eingabe

```

#### BMI

Der BMI ist heute das bekannteste Maß, um Übergewicht und Adipositas und damit einen erhöhten Körperfettanteil zu diagnostizieren, auch wenn dieser Wert Limitationen aufweist und  und als Parameter diskutiert wird.  
...
Zusätzlich kann man ausgeben lassen, welche Variable bei der Vorhersage besonders relevant war und welche Variablen nicht so relevant gewesen sind.
