...
```{r}
#| include: false
# Dieser Code-Block existiert, damit die Werte der Gütekriterien nicht von denen der Lösung abweichen, obwohl die Variable wHtR in einer Aufgabe erstellt werden muss.
 
if(ncol(bodyfat) == 18){
  bodyfat <- mutate(bodyfat, wHtR = (waist/groesse_m))
  bodyfat <- bodyfat[, c(1:17, 19, 18)]
} else {}
...
```{r}
#| include: false
# Dieser Code-Block existiert, damit die Fallstudie ohne Fehler durchläuft, obwohl der MSE in einer Aufgabe berechnet werden soll.
