...
- Wir bei einer erneuten Stichprobe aus der selben Zielpopulation das Ergebnis wieder lauten $\bar{x}=`r round(mw_Umfrage, 2)`$?

## Re-Sampling

Das Ergebnis bei einer anderen Stichprobe wird vermutlich leicht anders sein, als dass der vorhandenen Stichprobe.
...
- Welche Verteilungsform zeigt das Histogramm des Mittelwertes der Entfernung in der Re-Samples?
