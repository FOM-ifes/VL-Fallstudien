...
Gucken wir uns den Zusammenhang zwischen *Reichweite*, und *Verbrauch* über ein Liniendiagramm (`gf_line()`) für einen Reichweite von von 0 bis 100 (`seq()`) einmal an:
