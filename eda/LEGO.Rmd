...
- Wieviel Prozent der Sets kosten 10 Dollar oder weniger? (Tipp: Empirische Verteilungsfunktion, `pdata()`)

- Was ist größer: Der arithmetische Mittelwert oder der Median? (Tipp: `favstats()`). Gibt es eine Verbindung zum Histogramm?

- Was ist die Aussage des Ergebnisses von `qdata( ~ Amazon_Price, p = 0.95, data = lego)` (Tipp: Quantilsfunktion)?
