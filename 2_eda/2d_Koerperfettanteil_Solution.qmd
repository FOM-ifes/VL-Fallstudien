...
body_data <- body_data |>
  mutate(
    Gewicht_kg = Gewicht * 0.453592,
    Groesse_cm = Groesse * 2.54)
```
...
- Was können Sie dem Histogramm entnehmen?
  ...
  *Antwort:* Am häufigsten lagen die BMI-Werte ca. zwischen 24 und 26. Die Verteilung ist rechtsschief. Der BMI weist insgesamt eine Spannweite von ca. 18 bis 38 auf. Es gibt einen Ausreißer mit einem über einem BMI über 35.
