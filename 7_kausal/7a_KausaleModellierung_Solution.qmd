...
Als Beispiel wird der Datensatz `kreditstatus.csv`[^1] genutzt, der folgende Variablen enthält:

[^1]: Die Daten stammen ursprünglich von Lending Club, wurden durch DataCamp bearbeitet und bereitgestellt und hier mit einigen weiteren Modifikationen eingesetzt. Lending Club ist ein Peer-to-Peer-Kreditvermittler, der Daten zu angenommenen und abgelehnten Krediten über viele Jahre frei veröffentlicht hat. 
...
`arbeit` | Dauer des Anstellungsverhältnisses in Jahren[^2]
`einkommen` | jährliches Einkommen in 1000 USD

[^2]: *Hinweis:* Hier gibt es einige unplausible Werte, z. B. im Alter von 23 schon über 60 Jahre im Anstellungsverhältnis.
