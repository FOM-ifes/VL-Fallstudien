...
Nutzen Sie zur Beantwortung dieser Fragen die App <https://fomshinyapps.shinyapps.io/BaBeBi/> und notieren Sie die ausgegeben Werte für $\alpha$ und $\beta$. Wenn für Sie z. B. alle Werte für $\pi$ gleich plausibel sind, dann gilt $\alpha=\beta=1$:
