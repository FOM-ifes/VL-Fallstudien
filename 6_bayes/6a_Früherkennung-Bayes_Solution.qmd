...
-   Welche Verteilungsform hat *Ihre* Priori-Verteilung?
    ...
    *Antwort:* Individuelle Lösung. Hängt von den gewählten Parametern
    (`alpha`, `beta`) ab.
...
-   Gibt es keinen, einen oder zwei Modalwerte? Und wenn ja, wo liegen
    ...
    *Antwort:* Individuelle Lösung. Hängt von den gewählten Parametern
    (`alpha`, `beta`) ab. Allerdings kann es aufgrund der
    Parametrisierung nicht mehr als einen Modus geben.
...
Und es kann das **Kredibilitätsintervall** (oder
Glaubwürdigkeitsintervall, entspricht dem Konfidenzintervall in der
frequentistischen Statistik) berechnet werden:
...
-   Wo liegt der Erwartungswert der Posteriori-Verteilung im Verhältnis
    ...
    *Antwort:* I. d. R. liegt der Erwartungswert zwischen dem
    Erwartungswert der Priori-Verteilung und dem der Likelihood.
