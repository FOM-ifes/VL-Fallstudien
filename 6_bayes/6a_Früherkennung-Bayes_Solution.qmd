...
-   Welche Verteilungsform hat *Ihre* Prior-Verteilung?
    ...
    -   *Antwort: Individuelle Lösung. Hängt von den gewählten
        Parametern (alpha, beta) ab.*
...
-   Wo liegt der Erwartungswert der Posterior-Verteilung im Verhältnis
    ...
    -   *Antwort: I.d.R. liegt er Erwartungswert zwischen dem
        Erwartungswert der Prior-Verteilung und dem der Likelihood.*
