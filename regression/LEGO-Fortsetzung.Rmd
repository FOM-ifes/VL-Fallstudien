...
Zunächst betrachten wir nur die Serien `City` und `Friends` und behalten wir nur die Beobachtungen, für die das Theme ungleich DUPLO ist.
...
- Welchen modellierten Wert hat ein Set mit $x_j=10$ Bauteilen? 

- Gilt immer $\hat{y}_j = y_j$?
