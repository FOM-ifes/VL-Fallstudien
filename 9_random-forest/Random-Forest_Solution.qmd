...
\
  ...
  * Lösung: `r rf_model1$rsq[500]` = `r round(rf_model1$rsq[500]*100, 2)` %
...
Bedenkt man, dass ein "normaler" Körperfettanteil im Bereich von 10 - 22 % (Männer) bzw. 20 - 30 % (Frauen) scheint `r round(sqrt(rf_model1$mse[500]), 2)` % nicht niedrig.  
