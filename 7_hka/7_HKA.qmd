...
[^1]: Multipliziert man eine Matrix mit einem Vektor, erhält man als Ergebnis wieder einen Vektor. 
...
Den Skalierungsfaktor bezeichnet man als **Eigenwert** einer Matrix.
...
Dieses Paket enthält den Datensatz **wine**. 
Dieser Datensatz ist das Ergebnis einer chemischen Analyse von Weinen, die in der gleichen Region in Italien angebaut werden, aber von drei verschiedenen Weinsorten (barolo, grignolino, barbera) stammen. 
